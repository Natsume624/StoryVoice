...
android {
    ...
    buildTypes {
        ...
        debug {
            // Keep the same package id as the previous StoryVoice preview so
            // users can install this build as an in-place upgrade.
            buildConfigField("String", "RELEASE_DATE", "\"${SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Date())}\"")
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                ...
                val newName = "StoryVoice_${variantName}${abiPart}_v${versionName}_${versionCode}.apk"
