...
//                        style = MaterialTheme.typography.titleMedium
                    ...
                    AnimatedVisibility(visible = appPreferences.showEntries && selectedTabRow == 1) {
                        Box(
                            modifier = Modifier
                                .weight(1f)
                                .background(
    ...
    //                    enabled = !isAddingBook,
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.cd_search_books)
                        )
                    }
                    BadgedBox(
                        badge = {
                        ...
                        IconButton(
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(R.string.cd_sort_filter_books)
                            )
                        }
                    }
                    IconButton(
                            ...
                            text = {
                                Row(
                                    ...
                                    Icon(
                                        ...
                                        contentDescription = stringResource(R.string.cd_delete_shelf),
