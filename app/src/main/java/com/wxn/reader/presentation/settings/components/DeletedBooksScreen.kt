                ...
                navigationIcon = {
                    IconButton(onClick = {
                        ...
                        Icon(
                            ...
                            contentDescription = if (isSelectionMode) stringResource(R.string.cd_clear_selection) else stringResource(R.string.cd_navigate_back)
                        )
                    }
                },
                ...
                actions = {
                    if (isSelectionMode) {
                        IconButton(onClick = {
                            ...
                            Icon(Icons.Default.RestartAlt, contentDescription = stringResource(R.string.cd_restore_selected))
                        }
                                    ...
                                    if (!isSelectionMode) {
                                        Row {
                                            IconButton(onClick = {
                                                ...
                                                Icon(Icons.Default.RestartAlt, contentDescription = stringResource(R.string.cd_restore))
                                            }
                                            IconButton(onClick = { bookToDelete = book }) {
                                                Icon(
                                                    Icons.Outlined.Delete,
                                                    contentDescription = stringResource(R.string.cd_delete_permanently),
                                                    tint = MaterialTheme.colorScheme.error
                                                )
                                            }
                                        }
