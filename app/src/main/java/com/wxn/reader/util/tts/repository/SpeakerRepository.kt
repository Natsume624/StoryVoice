package com.wxn.reader.util.tts.repository
...
import com.wxn.reader.util.tts.SpeakerManager
import com.wxn.reader.util.tts.data.Option
import com.wxn.reader.util.tts.data.OutputFormat
import com.wxn.reader.util.tts.data.extractVoiceName
...
class SpeakerRepository(
    ...
    fun audioFormat() = preferenceDataSource.data.map {
        it[KEY_AUDIO_FORMAT] ?: OutputFormat.Audio24Khz48KbitrateMonoMp3.value
    }
